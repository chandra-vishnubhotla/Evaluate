 ...
 *   https://datatables.net/download/#dt/dt-2.0.8/fc-5.0.1/fh-4.0.1/r-3.0.2/sc-2.4.3/sl-2.0.3
 *
 * Included libraries:
 *   DataTables 2.0.8, FixedColumns 5.0.1, FixedHeader 4.0.1, Responsive 3.0.2, Scroller 2.4.3, Select 2.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.0.8/fc-5.0.1/fh-4.0.1/r-3.0.2/sc-2.4.3/sl-2.0.3",
